...
export default function Apps() {
    return (
        <section className="bg-alternative text-primary ">
            <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-7">
                ...
                <Link href="https://firmar.gob.ar/firmador/#/" target="_blank"  className="hover:text-white">
                    <div className="flex flex-col items-center py-6 bg-alternative hover:bg-primary cursor-pointer">
                    <div className="bg-white py-4 px-5 rounded-full">
                            <span className="text-3xl">
                                <Image src={logo} width={20} height={20} alt="Employees" />
                ...
                <Link href="https://login.salta.gob.ar/login" target="_blank" className="hover:text-white">
                    <div className="flex flex-col items-center py-6 bg-alternative hover:bg-primary cursor-pointer">
                    <div className="bg-white py-4 px-5 rounded-full">
                            <span className="text-3xl">
                                <Image src={logo} width={20} height={20} alt="Employees" />
                ...
                <Link href="https://mail.salta.gob.ar/" target="_blank" className="hover:text-white">
                    <div className="flex flex-col items-center py-6 bg-alternative hover:bg-primary cursor-pointer">
                    <div className="bg-white py-4 px-5 rounded-full">
                            <span className="text-3xl">
                                <Image src={logo} width={20} height={20} alt="Employees" />
                ...
                <Link href="https://sigep.salta.gob.ar/" target="_blank" className="hover:text-white">
                    <div className="flex flex-col items-center py-6 bg-alternative hover:bg-primary cursor-pointer">
                    <div className="bg-white py-4 px-5 rounded-full">
                            <span className="text-3xl">
                                <Image src={logo} width={20} height={20} alt="Employees" />

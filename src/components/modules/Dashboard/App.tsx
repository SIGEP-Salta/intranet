            ...
            */}
            ...
            >
                ...
                <div className="flex flex-col gap-0.5 text-left">
                    <p className="text-md font-semibold text-gray-800 leading-tight line-clamp-2">{name}</p>
                    <p className="text-sm text-gray-400 leading-tight line-clamp-1">{description}</p>
                </div>
            </Link>
        </Card>
    )
